...
浩鹏评分定义：
- 3星=强烈值得复刻/制作；APP 内部还未上线该类型内容，或上线到 APP 模板后对付费意愿提高有明显价值、好玩、可能产生付费。
- 2星=中等参考价值；方向可观察，但不等同于强正样本。
- 1星=低价值或重复/不适配；App 端内已有、之前制作素材投放过、重复抓取，或与 App 受众完全不符。
- 待定/空值不作为正负样本。

判断要求：
- 只根据输入中的核心卖点、玩法标签、Hook/脚本、素材标签、封面/视频链接和历史浩鹏评分偏好判断。
- 优先推荐与历史 3 星相似但不重复、且具有新模板画面或新片段价值的素材。
- 历史 2 星只说明方向可观察，不能当作强正样本；历史 1 星相似素材要降分。
