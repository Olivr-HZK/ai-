...
def _ve_fixed_footer() -> str:
    ...
    return (
        ...
        "若没有任何标签能覆盖核心玩法，玩法资产ID写 unmatched_play，"
        "玩法资产名称留空，玩法归类写未命中，不要新建玩法标签。\n"
        ...
        "【玩法资产ID】若命中已有玩法标签，只能写候选清单中的 asset_id；若不是任何已有玩法，写 unmatched_play。\n"
        "【玩法资产名称】若命中已有玩法标签，必须写候选清单中的完整中文标签；若未命中，留空，不要自造新标签或写泛技术词。\n"
        "【玩法变种ID】命中已有玩法标签时固定写 base；若未命中，写 unmatched_play。\n"
        "【玩法变种名称】命中已有玩法标签时固定写 基础变体；若未命中，留空。\n"
        "【玩法归类】只选一项：已沉淀玩法、未命中、不确定。命中候选玩法标签=已沉淀玩法；unmatched_play=未命中。\n"
...
多维表格玩法标签库候选清单（判断【玩法资产ID】只能引用这里的 asset_id；不匹配写 unmatched_play，不要新建玩法标签）：
{asset_catalog}
