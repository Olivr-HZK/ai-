...
from ua_workflows.video_enhancer.dom_video_url import (
...
async def _run(args: argparse.Namespace) -> None:
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            if not await _do_setup(page, is_tool=True, log_prefix="  ", order_by="latest", use_popularity_top1=False):
                print("[失败] 筛选未成功，中止", file=sys.stderr)
                sys.exit(3)
