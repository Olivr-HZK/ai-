...
# 流水线：爬取（test_arrow2_competitors，全局 ad_key 去重）→ data/arrow2_pipeline.db
...
#   ./scripts/arrow2_exposure_workflow.sh --debug --debug-dom-probe 5
#   ./scripts/arrow2_exposure_workflow.sh --debug --debug-dom-probe 5 --debug-dom-probe-only --skip-sync
...
#
# 地区：run_arrow2_batch 默认（未在 .env 设）为 ARROW2_ENRICH_DETAIL_COUNTRY=1、ARROW2_ENRICH_DETAIL_COUNTRY_DOM=1
